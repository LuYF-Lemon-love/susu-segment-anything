...
See the examples notebooks on [using SAM with prompts](/notebooks/01_predictor_example.ipynb) and [automatically generating masks](/notebooks/automatic_mask_generator_example.ipynb) for more details.
